 ...
 * @author crow_hou@126.com Add pipe support and fix the Wide character garbled
 *         bug.
 */
public class AXMLPrinter {
		...
		try {
			if (arguments.length >= 1) {
				...
				try {
					...
					if (m != null && m.invoke(System.class) != null) {
						log("Usage: AXMLPrinter <binary xml file>\n       or stdin | AXMLPrinter");
						return;
					}
				} catch (Throwable e) {
				}
	...
	private static void log(String format, Object... args)
		...
		System.out.write(String.format(format, args).getBytes("UTF-8"));
		System.out.println();
	}
